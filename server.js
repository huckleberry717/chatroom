    ...
    "data":{
        "messages": [
            ...
            { 
                ...
                "createdAt": Date.now(),
                "objectId": "NdQxqDK6OZgymJbb5IrRCsgjdfds"
            },
            {
                "text": "The fourth message",
                "createdAt": Date.now(),
                "objectId": "NdQxqDK6OZgymJbb5djflkskjdfl"
            }
...
persistentDb.pushToArray('/data/messages', newChatObj); //Figure out how to push this babe
